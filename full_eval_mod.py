...
def main():
    ...
    # changed to -5 for number of episodes, was -3 before
    ...
    #     else:
    #         epoch = int(s[-3])
    #     if len(int(epoch)) >= 4 and f.startswith(args.title) and f.endwith('.dat'):
    #         checkpoint.append((f, epoch))
